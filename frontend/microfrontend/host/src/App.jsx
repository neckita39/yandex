...
function App() {
	const Header = lazy(() => import('ui/Header').catch(() => {
			return { default: () => <div className="error">Component is not available!</div> };
		}),
	);

	const Footer = lazy(() => import('ui/Footer').catch(() => {
			return { default: () => <div className="error">Component is not available!</div> };
		}),
	);
	...
	const AddPlacePopup = lazy(() => import('photos/AddPlacePopup').catch(() => {
			return { default: () => <div className="error">Component is not available!</div> };
		}),
	);

	const PopupWithForm = lazy(() => import('ui/PopupWithForm').catch(() => {
			return { default: () => <div className="error">Component is not available!</div> };
		}),
	);

	const ImagePopup = lazy(() => import('ui/ImagePopup').catch(() => {
			return { default: () => <div className="error">Component is not available!</div> };
		}),
	);
